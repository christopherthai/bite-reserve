...
class Reservation(db.Model, SerializerMixin):
    ...
    def get_total_table_sizes(restaurant_id, start_time, end_time):
        ...
        """
        total_table_sizes = Reservation.query.filter(
            Reservation.restaurant_id == restaurant_id,
            Reservation.reservation_time >= start_time,
            Reservation.reservation_time <= end_time
        ).with_entities(func.sum(Reservation.table_size)).scalar()
    ...
    def validate_reservation_time(self, key, value):
        ...
        start_time, end_time = self.get_reservation_time_window(value, self.restaurant.res_duration)
        total_table_sizes = self.get_total_table_sizes(self.restaurant_id, start_time, end_time)
