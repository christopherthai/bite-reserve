...
import backgroundImage from '../top-view-menu-plate-with-cutlery.jpeg'; // Import your background image
      ...
      <div className="background-image-container">
        ...
        <h1 className="heading">Who We Are</h1>
          <p className="paragraph">
            Welcome to BiteReserve, your go-to platform for securing reservations at top-tier 
            restaurants across NYC. Our user-friendly system simplifies the booking process, 
            allowing you to effortlessly reserve tables at exclusive dining spots.  
          </p><p className="paragraph">  
            Join us and elevate your dining adventures in the Big Apple.
          </p>
        </div>
      </div>
    </div>
